...
if (_exhaustion_height >= 2) { 
    ...
    draw_rectangle(_dx + 2, _dy + 2 + _offset1, _dx + _wx - 2, _dy + _exhaustion_height + _offset1, false); 
}
...
if (_energy_height >= 2) {
    ...
    draw_rectangle(_dx + 2, _dy + 2 + _offset2, _dx + _wx - 2, _dy + _energy_height + _offset2, false);
