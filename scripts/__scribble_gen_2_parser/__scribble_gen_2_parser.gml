							...
							if (ds_map_exists(_effects_map, _tag_command_name)) {
								...
								if (sprite_exists(_sprite_index)) {
									...
									if (
										...
										if (SCRIBBLE_SPRITE_ALIGN_MODE == 0) {
											//Align to centre of line height
											var _sprite_y_offset = 0;
											var _sprite_space_h = _font_line_height;
										} else if (SCRIBBLE_SPRITE_ALIGN_MODE == 1) {
											//Align to centre of ascender
											var _sprite_y_offset = floor(
												_font_ascender_offset
													+ _font_ascender / 2
													- _font_line_height / 2
											);
											var _sprite_space_h = _font_ascender;
										} else if (SCRIBBLE_SPRITE_ALIGN_MODE == 2) {
										...
										_glyph_grid[#
											_glyph_count,
											__SCRIBBLE_GEN_GLYPH.__Y
										] = _state_valign_offset + _sprite_y_offset;
										_glyph_grid[#
											_glyph_count,
											__SCRIBBLE_GEN_GLYPH.__WIDTH
										] = _sprite_w;
