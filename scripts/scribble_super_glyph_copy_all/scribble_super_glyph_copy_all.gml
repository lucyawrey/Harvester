...
function scribble_super_glyph_copy_all(_target, _source, _overwrite) {
	...
	_target_font_data.__ascender = max(
		_target_font_data.__ascender,
		_source_font_data.__ascender
	);
	_target_font_data.__ascender_offset = max(
		_target_font_data.__ascender_offset,
		_source_font_data.__ascender_offset
	);
	ds_grid_set_region(
		_target_glyph_data_grid,
		0,
